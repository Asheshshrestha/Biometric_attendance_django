...
urlpatterns = [
    ...
    path('process/<int:card>/', views.process, name = 'process'),
    ...
    path('getcommand/<int:data>/',views.give_command,name='give_command'),
    path('givecommand/',views.get_command,name='get_command'),
]
